...
?>
<div style="font-size: 14px; margin-bottom: 10px;">Faça o login em sua conta ou realize um novo cadastro preenchendo os campos abaixo. Se estiver tudo ok, finalize seu pedido.</div>
<style>
